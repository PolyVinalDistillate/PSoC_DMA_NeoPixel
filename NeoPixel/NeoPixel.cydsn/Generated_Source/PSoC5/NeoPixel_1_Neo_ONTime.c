/*******************************************************************************
* File Name: NeoPixel_1_Neo_ONTime.c
* Version 1.0
*
* Description:
...
uint8 NeoPixel_1_Neo_ONTime_initVar = 0u;


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_Init
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_ONTime_Init(void) 
{
    ...
    NeoPixel_1_Neo_ONTime_PERIOD_REG = NeoPixel_1_Neo_ONTime_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_Enable
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_ONTime_Enable(void) 
{
    ...
    */
    NeoPixel_1_Neo_ONTime_AUX_CONTROL_REG |= NeoPixel_1_Neo_ONTime_COUNTER_START;
...
/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NeoPixel_1_Neo_ONTime_initVar - global variable.
*
* Return:
*  None.
*
...
void NeoPixel_1_Neo_ONTime_Start(void) 
{
    ...
    if(NeoPixel_1_Neo_ONTime_initVar == 0u)
    {
        NeoPixel_1_Neo_ONTime_Init();
        NeoPixel_1_Neo_ONTime_initVar = 1u;
    }

    /* Enable Count7 */
    NeoPixel_1_Neo_ONTime_Enable();
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_Stop
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_ONTime_Stop(void) 
{
    ...
    NeoPixel_1_Neo_ONTime_AUX_CONTROL_REG &= (uint8) ~((uint8) NeoPixel_1_Neo_ONTime_COUNTER_START);
...
/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NeoPixel_1_Neo_ONTime_COUNT_REG = (count & NeoPixel_1_Neo_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel_1_Neo_ONTime_COUNT_REG & NeoPixel_1_Neo_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NeoPixel_1_Neo_ONTime_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_ONTime_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel_1_Neo_ONTime_PERIOD_REG);
}
