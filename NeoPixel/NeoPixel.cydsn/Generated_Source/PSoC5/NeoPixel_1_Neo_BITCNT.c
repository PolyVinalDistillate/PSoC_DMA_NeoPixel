/*******************************************************************************
* File Name: NeoPixel_1_Neo_BITCNT.c
* Version 1.0
*
* Description:
...
uint8 NeoPixel_1_Neo_BITCNT_initVar = 0u;


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_Init
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_BITCNT_Init(void) 
{
    ...
    NeoPixel_1_Neo_BITCNT_PERIOD_REG = NeoPixel_1_Neo_BITCNT_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_Enable
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_BITCNT_Enable(void) 
{
    ...
    */
    NeoPixel_1_Neo_BITCNT_AUX_CONTROL_REG |= NeoPixel_1_Neo_BITCNT_COUNTER_START;
...
/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NeoPixel_1_Neo_BITCNT_initVar - global variable.
*
* Return:
*  None.
*
...
void NeoPixel_1_Neo_BITCNT_Start(void) 
{
    ...
    if(NeoPixel_1_Neo_BITCNT_initVar == 0u)
    {
        NeoPixel_1_Neo_BITCNT_Init();
        NeoPixel_1_Neo_BITCNT_initVar = 1u;
    }

    /* Enable Count7 */
    NeoPixel_1_Neo_BITCNT_Enable();
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_Stop
********************************************************************************
*
* Summary:
...
void NeoPixel_1_Neo_BITCNT_Stop(void) 
{
    ...
    NeoPixel_1_Neo_BITCNT_AUX_CONTROL_REG &= (uint8) ~((uint8) NeoPixel_1_Neo_BITCNT_COUNTER_START);
...
/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NeoPixel_1_Neo_BITCNT_COUNT_REG = (count & NeoPixel_1_Neo_BITCNT_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel_1_Neo_BITCNT_COUNT_REG & NeoPixel_1_Neo_BITCNT_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NeoPixel_1_Neo_BITCNT_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NeoPixel_1_Neo_BITCNT_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel_1_Neo_BITCNT_PERIOD_REG);
}
