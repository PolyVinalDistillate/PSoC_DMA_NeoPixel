/*******************************************************************************
* File Name: NeoPixDrv_1_ONTime.c
* Version 1.0
*
* Description:
...
uint8 NeoPixDrv_1_ONTime_initVar = 0u;


/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_Init
********************************************************************************
*
* Summary:
...
void NeoPixDrv_1_ONTime_Init(void) 
{
    ...
    NeoPixDrv_1_ONTime_PERIOD_REG = NeoPixDrv_1_ONTime_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_Enable
********************************************************************************
*
* Summary:
...
void NeoPixDrv_1_ONTime_Enable(void) 
{
    ...
    */
    NeoPixDrv_1_ONTime_AUX_CONTROL_REG |= NeoPixDrv_1_ONTime_COUNTER_START;
...
/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NeoPixDrv_1_ONTime_initVar - global variable.
*
* Return:
*  None.
*
...
void NeoPixDrv_1_ONTime_Start(void) 
{
    ...
    if(NeoPixDrv_1_ONTime_initVar == 0u)
    {
        NeoPixDrv_1_ONTime_Init();
        NeoPixDrv_1_ONTime_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_Stop
********************************************************************************
*
* Summary:
...
void NeoPixDrv_1_ONTime_Stop(void) 
{
    ...
    NeoPixDrv_1_ONTime_AUX_CONTROL_REG &= (uint8) ~((uint8) NeoPixDrv_1_ONTime_COUNTER_START);
...
/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NeoPixDrv_1_ONTime_COUNT_REG = (count & NeoPixDrv_1_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NeoPixDrv_1_ONTime_COUNT_REG & NeoPixDrv_1_ONTime_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NeoPixDrv_1_ONTime_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NeoPixDrv_1_ONTime_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NeoPixDrv_1_ONTime_PERIOD_REG);
}
