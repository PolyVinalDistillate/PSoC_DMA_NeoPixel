/*******************************************************************************
* File Name: NeoPixel2_1_Count7_2.c
* Version 1.0
*
* Description:
...
uint8 NeoPixel2_1_Count7_2_initVar = 0u;


/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_Init
********************************************************************************
*
* Summary:
...
void NeoPixel2_1_Count7_2_Init(void) 
{
    ...
    NeoPixel2_1_Count7_2_PERIOD_REG = NeoPixel2_1_Count7_2_INITIAL_PERIOD;
}


/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_Enable
********************************************************************************
*
* Summary:
...
void NeoPixel2_1_Count7_2_Enable(void) 
{
    ...
    */
    NeoPixel2_1_Count7_2_AUX_CONTROL_REG |= NeoPixel2_1_Count7_2_COUNTER_START;
...
/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_Start
********************************************************************************
*
* Summary:
...
*
* Global Variables:
*  NeoPixel2_1_Count7_2_initVar - global variable.
*
* Return:
*  None.
*
...
void NeoPixel2_1_Count7_2_Start(void) 
{
    ...
    if(NeoPixel2_1_Count7_2_initVar == 0u)
    {
        NeoPixel2_1_Count7_2_Init();
        NeoPixel2_1_Count7_2_initVar = 1u;
    }
...
/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_Stop
********************************************************************************
*
* Summary:
...
void NeoPixel2_1_Count7_2_Stop(void) 
{
    ...
    NeoPixel2_1_Count7_2_AUX_CONTROL_REG &= (uint8) ~((uint8) NeoPixel2_1_Count7_2_COUNTER_START);
...
/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_WriteCounter
********************************************************************************
*
* Summary:
...
{
    NeoPixel2_1_Count7_2_COUNT_REG = (count & NeoPixel2_1_Count7_2_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_ReadCounter
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel2_1_Count7_2_COUNT_REG & NeoPixel2_1_Count7_2_COUNT_7BIT_MASK);
}


/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_WritePeriod
********************************************************************************
*
* Summary:
...
{
    NeoPixel2_1_Count7_2_PERIOD_REG = period;
}


/*******************************************************************************
* Function Name: NeoPixel2_1_Count7_2_ReadPeriod
********************************************************************************
*
* Summary:
...
{
    return(NeoPixel2_1_Count7_2_PERIOD_REG);
}
